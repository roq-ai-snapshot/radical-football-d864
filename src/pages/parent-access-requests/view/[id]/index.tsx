...
import { getParentAccessRequestById } from 'apiSdk/parent-access-requests';
...
function ParentAccessRequestViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Parent Access Request Detail View
          </Text>
          {hasAccess('parent_access_request', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/parent-access-requests/edit/${data?.id}`} passHref legacyBehavior>
              <Button
