...
-- AddForeignKey
ALTER TABLE "parent_access_request" ADD CONSTRAINT "parent_access_request_parent_id_fkey" FOREIGN KEY ("parent_id") REFERENCES "parent"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "parent_access_request" ADD CONSTRAINT "parent_access_request_player_id_fkey" FOREIGN KEY ("player_id") REFERENCES "player"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
